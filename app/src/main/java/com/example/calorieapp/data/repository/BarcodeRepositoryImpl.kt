...
import com.example.calorieapp.data.DataSource.remote.RetrofitInstance
...
class BarcodeRepositoryImpl @Inject constructor(
    ...
    override suspend fun getDailySummary(): DailyMacrosSummary? {
        return productDao.getTodayTotalMacros()
    }
